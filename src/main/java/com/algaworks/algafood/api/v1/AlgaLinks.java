...
public class AlgaLinks {
    ...
    public Link linkToGrupos(final String rel) {
    ...
    public Link linkToGrupoPermissoes(final Long grupoId, final String rel) {
    ...
    public Link linkToEstatisticasVendasDiarias(final String rel) {
       ...
       final String pedidosUrl = linkTo(methodOn(EstatisticasController.class)
