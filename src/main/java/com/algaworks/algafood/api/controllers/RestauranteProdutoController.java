...
import com.algaworks.algafood.api.openapi.controllers.RestauranteProdutoControllerOpenApi;
...
@RestController
@RequestMapping(path = "/restaurantes/{id}/produtos", produces = MediaType.APPLICATION_JSON_VALUE)
