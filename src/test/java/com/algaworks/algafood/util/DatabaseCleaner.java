...
public class DatabaseCleaner {
    ...
    private void clear(final List<String> tableNames) throws SQLException {
        final Statement statement = buildSqlStatement(tableNames);
    ...
    private void addTruncateSatements(final List<String> tableNames, final Statement statement) {
